...
class PersonalMatchWhatProudScreen extends StatefulWidget {
  const PersonalMatchWhatProudScreen({super.key});

  @override
  State<PersonalMatchWhatProudScreen> createState() => _PersonalMatchWhatProudScreenState();
}

class _PersonalMatchWhatProudScreenState extends State<PersonalMatchWhatProudScreen> {
  int? selectedIdx;

  final options = [
    'A. Deeply personalized and emotionally resonant gifts',
    'B. Impressive or luxurious gifts that reflect your status',
    'C. Practical gifts that fulfill a clear need',
    'D. Experiences or moments rather than physical items',
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'What type of gifts do you feel proudest to give?',
