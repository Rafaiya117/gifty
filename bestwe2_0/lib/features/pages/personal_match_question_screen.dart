...
class PersonalMatchQuestionScreen extends StatefulWidget {
  const PersonalMatchQuestionScreen({super.key});

  @override
  State<PersonalMatchQuestionScreen> createState() => _PersonalMatchQuestionScreenState();
}

class _PersonalMatchQuestionScreenState extends State<PersonalMatchQuestionScreen> {
  int? selectedIdx;

  @override
  Widget build(BuildContext context) {
    final options = [
      'A. Making the recipient feel deeply understood',
      'B. Creating excitement and surprise',
      'C. Offering something practical and useful',
      'D. Demonstrating thoughtfulness through effort or cost',
    ];
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  // onPressed: selectedIdx != null ? () => context.push('/personal-match-result') : null,
