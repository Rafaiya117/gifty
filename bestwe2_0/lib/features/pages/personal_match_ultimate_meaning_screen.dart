...
class PersonalMatchUltimateMeaningScreen extends StatefulWidget {
  const PersonalMatchUltimateMeaningScreen({super.key});

  @override
  State<PersonalMatchUltimateMeaningScreen> createState() => _PersonalMatchUltimateMeaningScreenState();
}

class _PersonalMatchUltimateMeaningScreenState extends State<PersonalMatchUltimateMeaningScreen> {
  int? selectedIdx;

  @override
  Widget build(BuildContext context) {
    final options = [
      'A. More personalized suggestions tailored to each recipient',
      'B. Assurance of the recipient\'s genuine appreciation',
      'C. Less stress or uncertainty around gift selection',
      'D. Creating more lasting emotional memories',
    ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Ultimately, what would make your gift-giving feel more meaningful?',
