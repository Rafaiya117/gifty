...
class PersonalMatchHowThinkScreen extends StatefulWidget {
  const PersonalMatchHowThinkScreen({super.key});

  @override
  State<PersonalMatchHowThinkScreen> createState() => _PersonalMatchHowThinkScreenState();
}

class _PersonalMatchHowThinkScreenState extends State<PersonalMatchHowThinkScreen> {
  int? selectedIdx;

  final options = [
    'A. "They truly understand me."',
    'B. "They are generous and thoughtful."',
    'C. "They care about what I need."',
    'D. "They always know how to surprise and delight."',
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'How do you want recipients to think of you after receiving your gift?',
