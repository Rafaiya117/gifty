...
class PersonalMatchWhyGiftScreen extends StatefulWidget {
  const PersonalMatchWhyGiftScreen({super.key});

  @override
  State<PersonalMatchWhyGiftScreen> createState() => _PersonalMatchWhyGiftScreenState();
}

class _PersonalMatchWhyGiftScreenState extends State<PersonalMatchWhyGiftScreen> {
  int? selectedIdx;

  final options = [
    'A. To strengthen relationships',
    'B. To fulfill social or cultural expectations',
    'C. To express gratitude or appreciation',
    'D. To leave a lasting memory or impression',
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Why do you most often choose to give gifts?',
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  // onPressed: selectedIdx != null ? () => context.push('/personal-match-what-proud') : null,
                  onPressed: selectedIdx != null
                      ? () {
                          final appState = context.read<ApplicationState>();
                          appState.giftpotState.addResponseFormAnswer(
                            ResponseFormItem(
                              question: 'Why do you most often choose to give gifts?',
                              responseText: options[selectedIdx!],
                            ),
                          );
                          // Navigate to the next screen
                          context.push('/personal-match-what-proud');
                        }: null,
                  child: Text(
                    'Next',
                    style: GoogleFonts.poppins(
