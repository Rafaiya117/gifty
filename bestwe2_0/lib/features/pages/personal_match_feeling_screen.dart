...
class PersonalMatchFeelingScreen extends StatefulWidget {
  const PersonalMatchFeelingScreen({super.key});

  @override
  State<PersonalMatchFeelingScreen> createState() => _PersonalMatchFeelingScreenState();
}

class _PersonalMatchFeelingScreenState extends State<PersonalMatchFeelingScreen> {
  int? selectedIdx;

  final options = [
    'A. Disappointed in yourself',
    'B. Uncertain about your relationship with the recipient',
    'C. Motivated to better understand the recipient',
    "D. Unaffected; it's the thought that counts",
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "If your gift isn't received enthusiastically, you tend to feel ?",
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  // onPressed: selectedIdx != null ? () => context.push('/personal-match-why-gift') : null,
                  onPressed: selectedIdx != null ? () {
                    // Add the selected answer to the response form
                    final appState = context.read<ApplicationState>();
                    appState.giftpotState.addResponseFormAnswer(
                      ResponseFormItem(
                        question: "If your gift isn't received enthusiastically, you tend to feel ?",
                        responseText: options[selectedIdx!],
                      ),
                    );
                    // Navigate to the next screen
                    context.push('/personal-match-why-gift');
                  } : null,
                  child: Text(
                    'Next',
                    style: GoogleFonts.poppins(
