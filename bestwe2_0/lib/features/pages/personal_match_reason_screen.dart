...
class PersonalMatchReasonScreen extends StatefulWidget {
  const PersonalMatchReasonScreen({super.key});

  @override
  State<PersonalMatchReasonScreen> createState() => _PersonalMatchReasonScreenState();
}

class _PersonalMatchReasonScreenState extends State<PersonalMatchReasonScreen> {
  int? selectedIdx;
